import { ActionMode, ActionSource, SelectionType } from 'app/pages/editor/model/actionmode';
import { LayerUtil, MorphableLayer, VectorLayer } from 'app/pages/editor/model/layers';
import { Animation, PathAnimationBlock } from 'app/pages/editor/model/timeline';
import { ActionModeUtil } from 'app/pages/editor/scripts/actionmode';
...
import { State } from 'app/pages/editor/store/reducer';
import { createDeepEqualSelector, getEditorState } from 'app/pages/editor/store/selectors';
import {
  getAnimation,
