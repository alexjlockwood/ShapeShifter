import { getActionMode, isActionMode } from 'app/pages/editor/store/actionmode/selectors';
import {
...
import { getHoveredLayerId } from 'app/pages/editor/store/paper/selectors';
import { isBeingReset } from 'app/pages/editor/store/reset/selectors';
import {
  getAnimation,
  getSelectedBlockIds,
