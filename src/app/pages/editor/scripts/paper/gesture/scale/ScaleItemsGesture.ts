...
import { Path } from 'app/pages/editor/model/paths';
import { MathUtil } from 'app/pages/editor/scripts/common';
import { Gesture } from 'app/pages/editor/scripts/paper/gesture';
import { PaperLayer, SelectionBoundsRaster } from 'app/pages/editor/scripts/paper/item';
import { PaperUtil, SnapUtil } from 'app/pages/editor/scripts/paper/util';
import { PaperService } from 'app/pages/editor/services';
import { Line } from 'app/pages/editor/store/paper/actions';
