...
import { ClickDetector } from 'app/pages/editor/scripts/paper/detector';
import { Gesture } from 'app/pages/editor/scripts/paper/gesture';
import {
  EllipseGesture,
  PencilGesture,
  RectangleGesture,
} from 'app/pages/editor/scripts/paper/gesture/create';
import {
...
} from 'app/pages/editor/scripts/paper/gesture/edit';
import { HoverGesture } from 'app/pages/editor/scripts/paper/gesture/hover';
import {
  RotateItemsDragPivotGesture,
  RotateItemsGesture,
} from 'app/pages/editor/scripts/paper/gesture/rotate';
import { ScaleItemsGesture } from 'app/pages/editor/scripts/paper/gesture/scale';
import {
  BatchSelectItemsGesture,
  DeselectItemGesture,
  EditPathGesture,
  SelectDragCloneItemsGesture,
} from 'app/pages/editor/scripts/paper/gesture/select';
import { TransformPathsGesture } from 'app/pages/editor/scripts/paper/gesture/transform';
import { HitTests, PaperLayer } from 'app/pages/editor/scripts/paper/item';
import { PaperUtil } from 'app/pages/editor/scripts/paper/util';
