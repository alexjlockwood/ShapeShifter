...
import { NameProperty } from 'app/pages/editor/model/properties';
import { ColorUtil, MathUtil, Matrix } from 'app/pages/editor/scripts/common';
import { optimizeSvg } from 'app/pages/editor/scripts/svgo';
