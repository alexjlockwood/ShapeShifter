...
import { CursorType } from 'app/pages/editor/model/paper';
import { bugsnagClient } from 'app/pages/editor/scripts/bugsnag';
...
import { getActionMode, getActionModeHover } from 'app/pages/editor/store/actionmode/selectors';
import { isWorkspaceDirty } from 'app/pages/editor/store/common/selectors';
import { getCursorType } from 'app/pages/editor/store/paper/selectors';
