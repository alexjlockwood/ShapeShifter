...
import { INTERPOLATORS } from 'app/pages/editor/model/interpolators';
import {
  ClipPathLayer,
  GroupLayer,
  Layer,
...
import { Animation, AnimationBlock, PathAnimationBlock } from 'app/pages/editor/model/timeline';
import { MathUtil, Matrix, ModelUtil } from 'app/pages/editor/scripts/common';
import { Action, State, Store } from 'app/pages/editor/store';
...
import {
  ...
  SetSelectedLayers,
  SetVectorLayer,
} from 'app/pages/editor/store/layers/actions';
import {
  getCollapsedLayerIds,
  getHiddenLayerIds,
  getSelectedLayerIds,
  getVectorLayer,
} from 'app/pages/editor/store/layers/selectors';
import {
  SelectAnimation,
  SetAnimation,
  SetSelectedBlocks,
} from 'app/pages/editor/store/timeline/actions';
import {
  getAnimation,
  getSelectedBlockIds,
  isAnimationSelected,
} from 'app/pages/editor/store/timeline/selectors';
