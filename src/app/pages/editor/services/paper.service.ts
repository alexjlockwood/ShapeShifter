...
import { CursorType, ToolMode } from 'app/pages/editor/model/paper';
...
import { getHiddenLayerIds, getSelectedLayerIds } from 'app/pages/editor/store/layers/selectors';
import {
  CreatePathInfo,
  EditPathInfo,
  RotateItemsInfo,
...
import {
  ...
  getZoomPanInfo,
} from 'app/pages/editor/store/paper/selectors';
import { getAnimatedVectorLayer } from 'app/pages/editor/store/playback/selectors';
