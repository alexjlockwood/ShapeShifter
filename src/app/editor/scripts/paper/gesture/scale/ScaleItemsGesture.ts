import { LayerUtil, MorphableLayer, VectorLayer } from 'app/editor/model/layers';
import { Path } from 'app/editor/model/paths';
import { MathUtil } from 'app/editor/scripts/common';
import { Gesture } from 'app/editor/scripts/paper/gesture';
import { PaperLayer, SelectionBoundsRaster } from 'app/editor/scripts/paper/item';
import { PaperUtil, SnapUtil } from 'app/editor/scripts/paper/util';
import { PaperService } from 'app/editor/services';
import { Line } from 'app/editor/store/paper/actions';
