...
import { ClickDetector } from 'app/editor/scripts/paper/detector';
import { Gesture } from 'app/editor/scripts/paper/gesture';
import { EllipseGesture, PencilGesture, RectangleGesture } from 'app/editor/scripts/paper/gesture/create';
import {
...
} from 'app/editor/scripts/paper/gesture/edit';
import { HoverGesture } from 'app/editor/scripts/paper/gesture/hover';
import { RotateItemsDragPivotGesture, RotateItemsGesture } from 'app/editor/scripts/paper/gesture/rotate';
import { ScaleItemsGesture } from 'app/editor/scripts/paper/gesture/scale';
import {
  BatchSelectItemsGesture,
  DeselectItemGesture,
  EditPathGesture,
  SelectDragCloneItemsGesture,
} from 'app/editor/scripts/paper/gesture/select';
import { TransformPathsGesture } from 'app/editor/scripts/paper/gesture/transform';
import { HitTests, PaperLayer } from 'app/editor/scripts/paper/item';
import { PaperUtil } from 'app/editor/scripts/paper/util';
