...
import { DialogService } from 'app/editor/components/dialogs';
import { ProjectService } from 'app/editor/components/project';
import { ActionMode } from 'app/editor/model/actionmode';
import {
  ClipPathLayer,
  GroupLayer,
  Layer,
  ...
  PathLayer,
  VectorLayer,
} from 'app/editor/model/layers';
import { Animation, AnimationBlock } from 'app/editor/model/timeline';
import { ModelUtil } from 'app/editor/scripts/common';
import { Dragger } from 'app/editor/scripts/dragger';
import { IntervalTree } from 'app/editor/scripts/intervals';
import { DestroyableMixin } from 'app/editor/scripts/mixins';
import {
  ActionModeService,
  FileExportService,
  FileImportService,
  ...
  PlaybackService,
  ThemeService,
} from 'app/editor/services';
import { Shortcut, ShortcutService } from 'app/editor/services/shortcut.service';
import { Duration, SnackBarService } from 'app/editor/services/snackbar.service';
import { State, Store } from 'app/editor/store';
import { BatchAction } from 'app/editor/store/batch/actions';
import { getLayerTimelineState, isWorkspaceDirty } from 'app/editor/store/common/selectors';
import { SetSelectedLayers, SetVectorLayer } from 'app/editor/store/layers/actions';
import { getVectorLayer } from 'app/editor/store/layers/selectors';
import { ResetWorkspace } from 'app/editor/store/reset/actions';
