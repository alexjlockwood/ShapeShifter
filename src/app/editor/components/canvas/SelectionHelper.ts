import { ActionSource, HoverType } from 'app/editor/model/actionmode';
import { LayerUtil } from 'app/editor/model/layers';
import { ProjectionOntoPath } from 'app/editor/model/paths';
import { MathUtil, Point } from 'app/editor/scripts/common';
