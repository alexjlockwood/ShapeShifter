...
import { Command, HitResult, Path, SubPath } from 'app/editor/model/paths';
import { MathUtil, Matrix, Point } from 'app/editor/scripts/common';
...
import { getCanvasOverlayState } from 'app/editor/store/common/selectors';
