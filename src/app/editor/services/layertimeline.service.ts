...
import { INTERPOLATORS } from 'app/editor/model/interpolators';
import {
  ClipPathLayer,
  GroupLayer,
  Layer,
...
import { Animation, AnimationBlock, PathAnimationBlock } from 'app/editor/model/timeline';
import { MathUtil, Matrix, ModelUtil } from 'app/editor/scripts/common';
...
import {
  ...
  SetSelectedLayers,
  SetVectorLayer,
} from 'app/editor/store/layers/actions';
import {
...
import { SelectAnimation, SetAnimation, SetSelectedBlocks } from 'app/editor/store/timeline/actions';
import {
  getAnimation,
  getSelectedBlockIds,
  isAnimationSelected,
