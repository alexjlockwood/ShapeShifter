...
import { CursorType, ToolMode } from 'app/editor/model/paper';
import { Point } from 'app/editor/scripts/common';
import { Action, State, Store } from 'app/editor/store';
import { BatchAction } from 'app/editor/store/batch/actions';
import { getHiddenLayerIds, getSelectedLayerIds } from 'app/editor/store/layers/selectors';
import {
  CreatePathInfo,
  EditPathInfo,
  RotateItemsInfo,
  ...
  TransformPathsInfo,
  ZoomPanInfo,
} from 'app/editor/store/paper/actions';
import {
  getCreatePathInfo,
  getCursorType,
  getEditPathInfo,
  ...
  getZoomPanInfo,
} from 'app/editor/store/paper/selectors';
import { getAnimatedVectorLayer } from 'app/editor/store/playback/selectors';
