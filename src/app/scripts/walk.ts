...
function walkImpl(root, traversalStrategy, beforeFunc, afterFunc, context, collectResults?: boolean) {
  var visited = [];
  return (function _walk(value, key?: any, parent?: any) {
...
(myexports as any).collect = myexports.map;
(myexports as any).detect = myexports.find;
(myexports as any).select = myexports.filter;
...
function walk(traversalStrategy?: any) {
  var walker: any = _.clone(myexports);
