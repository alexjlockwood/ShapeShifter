...
export const convertTransforms = {
  active: true,
  type: 'perItem',
  fn: convertTransformsFn,
  params: {
...
var cleanupOutData = tools.cleanupOutData,
  transform2js = transforms.transform2js,
  transformsMultiply = transforms.transformsMultiply,
  matrixToTransform = transforms.matrixToTransform,
  degRound,
  floatRound,
  transformRound;
