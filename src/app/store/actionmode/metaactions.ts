...
export const DELETE_SELECTED_PATH_DETAILS = '__metaactionmode__DELETE_SELECTED_PATH_DETAILS';
...
export class DeleteSelectedPathDetails implements Action {
  readonly type = DELETE_SELECTED_PATH_DETAILS;
}
