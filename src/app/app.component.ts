...
export class AppComponent implements OnInit, OnDestroy {
  ...
  private initDebugMode() {
    ...
    // </svg>`));
    // this.layerStateService.setLayer(EditorType.Start, SvgLoader.loadVectorLayerFromSvgString(`
    ...
    //   </path>
    // </svg>`));
    // this.layerStateService.setLayer(EditorType.End, SvgLoader.loadVectorLayerFromSvgString(`
    // <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    //   <path
    //     stroke="#000"
    //     stroke-width="0.2"
