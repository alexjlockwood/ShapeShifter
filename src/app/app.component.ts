...
export class AppComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  private initDebugMode() {
    ...
    //      viewBox="0 0 800 400" style="enable-background:new 9 80 800 400;">
    // <path id="circle" fill="#cccccc" d="M490.1,280.649c0,44.459-36.041,80.5-80.5,80.5s-80.5-36.041-80.5-80.5s36.041-80.5,80.5-80.5
    //     S490.1,236.19,490.1,280.649z"/>


    // <path id="star" fill="#cccccc" d="M409.6,198.066l26.833,54.369l60,8.719l-43.417,42.321l10.249,59.758L409.6,335.019
